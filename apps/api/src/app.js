...
// Rate limiters are defined and applied in the auth routes module.
// Security headers.
...
// Register Paystack webhook route BEFORE express.json() so handlers
// that require the raw request body can validate the signature safely.
const { registerPaystackRoutes } = require("./routes/paystack.routes");
...
// SESSION CHECK
// =========================
// Session endpoint moved to modular auth routes
...
// GET USER endpoint moved to `routes/auth.routes.js`
...
// Registration endpoint moved to `routes/auth.routes.js`

// =========================
// LOGIN
// =========================

// Login endpoint moved to `routes/auth.routes.js`
...
// Purchase PIN endpoints moved to `routes/auth.routes.js`
